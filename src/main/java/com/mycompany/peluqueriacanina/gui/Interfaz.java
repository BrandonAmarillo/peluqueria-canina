...
public class Interfaz extends JFrame {
    ...
    public Interfaz() {
        ...
        // Titulo de la peluqueria

        gbc.gridx = 0; // Columna 0
        gbc.gridy = 0; // Fila 0
        gbc.gridwidth = 2; // Ocupa 3 columnas
        gbc.fill = GridBagConstraints.NONE; // Rellena horizontalmente
        gbc.anchor = GridBagConstraints.CENTER; // Centra el texto
        gbc.insets = new Insets(10, 10, 10, 10); // Margen superior e inferior
        JLabel titulo = new JLabel("Peluquería Canina");
        ...
        gbc.gridx = 1;
        gbc.gridy = 5;
        jcAlergico = new JComboBox<>(new String[] { "Si", "No" });
        ...
        gbc.gridx = 1;
        gbc.gridy = 6;
        jcAtencionEspecial = new JComboBox<>(new String[] { "Si", "No" });
        ...
        gbc.gridx = 5; // Columna 5 (a la derecha de los campos)
    ...
    private void limpiarCampos() {
        jtNumCliente.setText("");
        jtNombrePerro.setText("");
        jtRaza.setText("");
        jtColor.setText("");
        jcAlergico.setSelectedIndex(-1);
